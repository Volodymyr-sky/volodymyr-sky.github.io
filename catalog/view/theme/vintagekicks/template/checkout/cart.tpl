    ...
    <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="cart">
      <table class="cart">
        <tr class="cart-headings">
          <th align="left"><?php echo $column_remove; ?></th>
          <th align="left"><?php echo $column_image; ?></th>
          <th align="left"><?php echo $column_name; ?></th>
          <th align="left" class="col-model"><?php echo $column_model; ?></th>
          <th align="left"><?php echo $column_quantity; ?></th>
          <?php if ($display_price) { ?>
		  <th align="left" class="col-price"><?php echo $column_price; ?></th>
        ...
        <tr class="<?php echo $class; ?>">
          ...
          <td align="left" valign="top" class="col-model"><?php echo $product['model']; ?></td>
          <td align="right" valign="top"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="3" /></td>
          <?php if ($display_price) { ?>
		  <td align="right" valign="top" class="col-price"><?php echo $product['price']; ?></td>
	  ...
	  <?php } ?>
      <a onclick="$('#cart').submit();" class="button"><span>Обновить/Удалить</span></a>
      <a onclick="location = '<?php echo str_replace('&amp;', '&', $continue); ?>'" class="button"><span><?php echo $button_shopping; ?></span></a>
