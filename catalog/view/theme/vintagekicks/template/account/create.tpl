...
<form action="<?php echo str_replace('&', '&amp;', $action); ?>"
	method="post" enctype="multipart/form-data" id="create">
<p><?php echo $text_account_already; ?></p>
<div class="create_box">
<b><?php echo $text_your_details; ?></b>

<table>
	<tr>
		<td width="150"><span class="required">*</span> <?php echo $entry_firstname; ?></td>
		<td>
			<input type="text" name="firstname" value="<?php echo $firstname; ?>" /> <?php if ($error_firstname) { ?>
...
<div class="create_box">
<b><?php echo $text_your_address; ?></b>
<table>
	<tr>
	...
	<tr>
		...
		<td><select name="country_id" id="country_id"
			onchange="$('select[name=\'zone_id\']').load('index.php?route=account/create/zone&country_id=' + this.value + '&zone_id=<?php echo $zone_id; ?>'); $('#postcode').load('index.php?route=account/create/postcode&country_id=' + this.value);">
...
<div class="create_box">
<b><?php echo $text_your_password; ?></b>
...
<table>
	<tr>
		...
		<td><?php if ($newsletter == 1) { ?> <input type="radio"
			name="newsletter" value="1" checked="checked" /> <?php echo $text_yes; ?>
		<input type="radio" name="newsletter" value="0" /> <?php echo $text_no; ?>
		<?php } else { ?> <input type="radio" name="newsletter" value="1" /> <?php echo $text_yes; ?>
...
<?php if ($text_agree) { ?>
	<table>
		<tr>
			...
			<td align="right" width="5"><a onclick="$('#create').submit();"
