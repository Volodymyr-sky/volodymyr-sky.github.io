...
<table style="font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 600px;">
  ...
  <?php } ?>
  <tr>
    <td align="center" style="font-size: 10px; border-top: 1px solid #069;"><a href="<?php echo $store_url; ?>" style="color: #069; font-weight: bold; text-decoration: none;"><?php echo $store_name; ?></a> <?php echo $text_powered_by; ?> <a href="http://myopencart.ru" style="text-decoration: none; color: #374953;">ocStore</a></td>
  </tr>
</table>
</body>
</html>
